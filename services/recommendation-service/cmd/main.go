...
import (
	...
	"github.com/elevatecompact/spark/services/recommendation-service/internal/config"
	"github.com/elevatecompact/spark/services/recommendation-service/internal/events"
	"github.com/elevatecompact/spark/services/recommendation-service/internal/handler"
...
func main() {
	...
	go func() {
		log.Info().Str("port", cfg.Port).Msg("recommendation-service starting")
