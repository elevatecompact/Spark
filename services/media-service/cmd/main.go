...
import (
	...
	"github.com/elevatecompact/spark/services/media-service/internal/config"
	"github.com/elevatecompact/spark/services/media-service/internal/domain"
	"github.com/elevatecompact/spark/services/media-service/internal/events"
	"github.com/elevatecompact/spark/services/media-service/internal/handler"
...
func main() {
	...
	svc := service.NewMediaService(repo, eventPub)
	h := handler.New(svc)
