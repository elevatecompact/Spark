...
import (
	...
	"github.com/elevatecompact/spark/services/moderation-service/internal/config"
	"github.com/elevatecompact/spark/services/moderation-service/internal/events"
	"github.com/elevatecompact/spark/services/moderation-service/internal/handler"
...
func main() {
	...
	repo := repository.NewModerationRepository(pool)
	...
	svc := service.NewModerationService(repo, eventPub)
	h := handler.New(svc)
