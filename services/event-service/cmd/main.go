...
import (
	...
	"github.com/elevatecompact/spark/services/event-service/internal/config"
	"github.com/elevatecompact/spark/services/event-service/internal/events"
	"github.com/elevatecompact/spark/services/event-service/internal/handler"
...
func main() {
	...
	svc := service.NewEventService(repo, eventPub)
	h := handler.New(svc)
	...
	go func() {
		log.Info().Str("port", cfg.Port).Msg("event-service starting")
