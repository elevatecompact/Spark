...
import (
	...
	"github.com/elevatecompact/spark/services/commerce-service/internal/config"
	"github.com/elevatecompact/spark/services/commerce-service/internal/domain"
	"github.com/elevatecompact/spark/services/commerce-service/internal/events"
	"github.com/elevatecompact/spark/services/commerce-service/internal/handler"
...
func main() {
	...
	repo := repository.NewCommerceRepository(pool)
	...
	svc := service.NewCommerceService(repo, eventPub)
	h := handler.New(svc)
	...
	go func() {
		log.Info().Str("port", cfg.Port).Msg("commerce-service starting")
