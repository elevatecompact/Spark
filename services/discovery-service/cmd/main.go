...
import (
	...
	"github.com/elevatecompact/spark/services/discovery-service/internal/config"
	"github.com/elevatecompact/spark/services/discovery-service/internal/domain"
	"github.com/elevatecompact/spark/services/discovery-service/internal/events"
	"github.com/elevatecompact/spark/services/discovery-service/internal/handler"
...
func main() {
	...
	svc := service.NewDiscoveryService(repo, eventPub)
	h := handler.New(svc)
	...
	go func() {
		log.Info().Str("port", cfg.Port).Msg("discovery-service starting")
